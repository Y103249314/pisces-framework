package com.pisces.framework.core.util;
...
public class DateWarpUtils {
	...
	public static final String YYYYMMDD_UNSIGNED = "yyyyMMdd";
	public static final String YYYYMMDDHH_UNSIGNED = "yyyyMMddHH";
	public static final String YYYYMMDDHHMM_UNSIGNED = "yyyyMMddHHmm";
	public static final String YYYYMMDDHHMMSS_UNSIGNED = "yyyyMMddHHmmss";
	public static final String YYYYMMDDHHMMSSSSS_UNSIGNED = "yyyyMMddHHmmssSSS";
	...
	public static final String YYYYMMDD_SLASHES= "yyyy/MM/dd";
	 ...
	 * @param date
	 *            输入时间
	 * @param unit 时间单位,只支持秒、分、时、天
	 * @param amount 数量，小于0即为减
	 * @return 加法后的时间
	 */
	public static Date add(Date date, TimeUnit unit, int amount) {
		...
		throw new UnsupportedOperationException("Unsupported unit : " + unit.name());
	}
